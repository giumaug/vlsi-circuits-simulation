...
C {devices/ipin.sym} 50 50 0 0 {name=in1 lab=in1}
C {devices/ipin.sym} 50 140 0 0 {name=in2 lab=in2}
C {devices/ipin.sym} 230 -120 0 0 {name=vdd lab=vdd}
C {devices/ipin.sym} 300 200 0 0 {name=vss lab=vss}
C {devices/opin.sym} 400 0 0 0 {name=out lab=out}
