...
C {devices/ipin.sym} 480 -460 0 0 {name=in lab=in}
C {devices/ipin.sym} 560 -600 0 0 {name=vdd lab=vdd}
C {devices/ipin.sym} 560 -330 0 0 {name=vss lab=vss}
